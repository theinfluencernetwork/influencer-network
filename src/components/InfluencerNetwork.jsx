    ...
    <section className="w-full px-6 py-12 bg-white text-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {categories.map((item, idx) => (
          <div
            key={idx}
            className="bg-black text-white rounded-xl p-8 shadow-lg hover:shadow-[0_8px_30px_rgba(255,0,0,0.7)] transform hover:-translate-y-2 transition-all duration-300"
          >
